      ...
      <FieldGroup className="gap-4">
        ...
        <Field className="gap-1.5">
          ...
          <Input
            ...
            autoComplete="email"
            defaultValue="estimator@strelza.com"
        ...
        <Field>
          <Button variant="outline" type="button" onClick={() => onLogin?.()} className="w-full h-10 font-medium">
          ...
          <FieldDescription className="px-6 text-center text-xs mt-2 text-muted-foreground">
            Sign in with your company email (@yourcompany.com)
          </FieldDescription>
        </Field>
      </FieldGroup>
    </form>
