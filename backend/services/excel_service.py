"""
Excel Service.
Handles reading, writing, and synchronizing Excel price list spreadsheets with SQLite.
"""
import os
import openpyxl
import json
...
def load_master_price_list(file_path: str = "", price_list_id: Optional[int] = None) -> List[Dict[str, Any]]:
    ...
    try:
        ...
        print(f"[Excel Service] Error loading SQLite price list for ID {price_list_id}: {e}")
        return []
